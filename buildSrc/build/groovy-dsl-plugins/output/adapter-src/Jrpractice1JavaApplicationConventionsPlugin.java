...
/**
 * Precompiled jrpractice1.java-application-conventions script plugin.
 **/
public class Jrpractice1JavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_Jrpractice1JavaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("jrpractice1.java-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_Jrpractice1JavaApplicationConventions").asSubclass(BasicScript.class);
